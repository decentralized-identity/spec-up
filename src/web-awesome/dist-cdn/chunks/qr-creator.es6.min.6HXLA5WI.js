  ...
  var A = { L: 1, M: 0, Q: 3, H: 2 }, y = /* @__PURE__ */ (function() {
    ...
    var a = [
      ...
      for (var a2 = b.h(), c2 = 0, d = 0; d < a2; d += 1) for (var g = 0; g < a2; g += 1) {
        for (var e2 = 0, t2 = b.a(d, g), p = -1; 1 >= p; p += 1) if (!(0 > d + p || a2 <= d + p)) for (var q = -1; 1 >= q; q += 1) 0 > g + q || a2 <= g + q || (0 != p || 0 != q) && t2 == b.a(d + p, g + q) && (e2 += 1);
        5 < e2 && (c2 += 3 + e2 - 5);
      }
      for (d = 0; d < a2 - 1; d += 1) for (g = 0; g < a2 - 1; g += 1) if (e2 = 0, b.a(d, g) && (e2 += 1), b.a(d + 1, g) && (e2 += 1), b.a(d, g + 1) && (e2 += 1), b.a(d + 1, g + 1) && (e2 += 1), 0 == e2 || 4 == e2) c2 += 3;
      ...
      for (g = e2 = 0; g < a2; g += 1) for (d = 0; d < a2; d += 1) b.a(d, g) && (e2 += 1);
    ...
    var a = [
      ...
      b = e2.length / 3;
      a2 = [];
      for (var d = 0; d < b; d += 1) for (var g = e2[3 * d], h = e2[3 * d + 1], t2 = e2[3 * d + 2], p = 0; p < g; p += 1) {
        var q = t2, f = {};
        f.o = h;
        f.j = q;
        a2.push(f);
...
export {
  qr_creator_es6_min_default as default
};
